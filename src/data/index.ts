...
export const navItems = [
  { title: 'Home', path: '/', id: 'home', active: true },
  { title: 'About', path: '/about', id: 'about', active: false },
  { title: 'Projects', path: '/projects', id: 'projects', active: false },
  { title: 'Services', path: '/services', id: 'services', active: false },
  { title: 'News', path: '/news', id: 'news', active: false },
  { title: 'Contact', path: '/contact', id: 'contact', active: false },
]
...
export const features = [
  {
    ...
    description: 'Vehicula at eget a arcu neque ultricies.',
  },
  {
    title: 'Designing Spaces',
    description: 'Ultricies liquet tempus vel amet.',
  },
  {
    title: 'Road Maintenance',
    description: 'Tempus vel amet eget egestas arcu non.',
  },
]
